  ...
  {alignmentCards.map((card, i) => (
    ...
    >
      <div className="flex justify-between items-start mb-8">
        ...
        <span className="text-[#FFFFF0] font-black text-3xl tracking-tighter opacity-90 group-hover:text-[#87AE73] transition-colors">
          {card.id}
        </span>
      ...
      <div className="w-16 h-[3px] bg-[#4A5D23] mt-10 group-hover:w-full transition-all duration-700 opacity-100 shadow-[0_0_15px_rgba(135,174,115,0.3)]"></div>
    </div>
  ))}
</div>
        </div>
